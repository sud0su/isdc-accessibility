...
let PolygonArea = '';
class IsdcAccessibility extends React.Component {
    constructor(props){
        super(props);
        this.state = {
			results: []
    ...
    handleOpen = () => {
		...
		// console.log(this.props.urlAccessibility);
		fetch(this.props.urlAccessibility, {
			method: "POST",
			dataType: "JSON",
			headers: {
            ...
            <div style={styles.wrapper}>
                <div className={"IconBox"}>
					...
					icon={<FontIcon 
						...
						style={{'background-color': '#0e7bf1'}}>accessibility_new</FontIcon>}
					/>
				</div>
            </div>
        )
...
export default IsdcAccessibility